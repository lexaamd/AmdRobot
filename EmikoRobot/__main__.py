...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ Tambahkan Ke Group Lu ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Lexanih \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"👋 Hallo tod ngentod:v {dispatcher.bot.first_name}. Nice to meet You.",
    ...
    if query.data == "emiko_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/amandes_nih"),
